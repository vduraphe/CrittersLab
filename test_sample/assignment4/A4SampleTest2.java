...
public class A4SampleTest2 {
	 ...
	 */
	public void testWalk() throws InvalidCritterException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
	 ...
	 */
	public void WalkEnergyTest() throws InvalidCritterException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		Critter.makeCritter("MyCritter1");
...
//		while (!c.isDead()) {
	 ...
	 */
	@Test
	public void RunDuringFightTest() throws InvalidCritterException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		int x = 0;
		int y = 0;
		int num = 2;
